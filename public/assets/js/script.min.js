...
$(".mobile-menu").click(function() {
	var wid = $('.pcoded-navbar').width();
	if (wid <= 60) {
		$(".pcoded-mtext").show("fast");
	}
	if (wid > 60) {
		$(".pcoded-mtext").hide("fast");
	}
});
$(".accordion-desc ul li .fa-arrow-right").hide();
$('.accordion-desc .tabs-left li').width(150);
$(".accordion-desc ul li .fa-arrow-left").click(function() {
	$('.accordion-desc .tabs-left li').width(60);	
	$('.accordion-desc .md-tabs .nav-item span').hide();
	$(".accordion-desc ul li .fa-arrow-left").hide();
	$(".accordion-desc ul li .fa-arrow-right").show();
});

$(".accordion-desc ul li .fa-arrow-right").click(function(){
	$('.accordion-desc .tabs-left li').width(150);	
	$('.accordion-desc .md-tabs .nav-item span').show();
	$(".accordion-desc ul li .fa-arrow-left").show();
	$(".accordion-desc ul li .fa-arrow-right").hide();
})
